...
{
    public TextMeshProUGUI PopulationLable;
    public TextMeshProUGUI GenerationLable;
    public TextMeshProUGUI GenomeLable;
    ...
    {
        PopulationLable.SetText(initialPopulation.ToString());
        GenerationLable.SetText(currentGeneration.ToString());
        GenomeLable.SetText(currentGenome.ToString());
    }
